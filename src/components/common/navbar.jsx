...
export const Navbar = ({ getData, setQuery, setIsOpenSidebar }) => {
    return (
        <div className="w-full h-[60px] flex items-center justify-between  px-4 ">
            <div>
                <div className="flex items-center gap-5 ml-5">

                    <button className="cursor-pointer hover:bg-[#333333] active:border active:border-white rounded-full p-2" onClick={() => setIsOpenSidebar(prev => !prev)}>
            ...
            <div className="flex h-[40px]">
                ...
                <button onClick={getData} className="w-[60px] h-full bg-[#424242] border border-neutral-700 rounded-tr-full rounded-br-full text-center cursor-pointer">
                    <svg className="ml-5 mt-1" width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
